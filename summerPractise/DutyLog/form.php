        ...
        <div class="table_panels d-flex flex-column align-items-center col-10 mx-auto">
            <div class="tabel_panel row my-5">
                ...
                <form action="" method="POST"  class="row">
                    ...
                    <input type="date" name="duty_date" value="<?php echo date("Y-m-d"); ?>" required>
            ...
            <div class="tabel_panel my-0">
                ...
                echo '<table>';
                echo '<tr><th>id</th><th>Имя охранника</th><th>Название поста</th><th>Дата дежурства</th><th>Действия</th></tr>';

                foreach ($result as $row) {
                    echo '<tr>';
                    echo '<td>' . $row['duty_id'] . '</td>';

                    // Редактирование записи
                    echo '<td>';
                    echo '<form action="" method="POST">';
                    echo '<input type="hidden" name="action" value="edit">';
                    echo '<input type="hidden" name="edit_id" value="' . $row['duty_id'] . '">';
                    ...
                    echo '<td>';
                    echo '<input type="date" name="edit_duty_date" value="' . $row['duty_date'] . '" required>';
                    echo '</td>';
                    ...
                    echo '<input type="hidden" name="delete_id" value="' . $row['duty_id'] . '">';
